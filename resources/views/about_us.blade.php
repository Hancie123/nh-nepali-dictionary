                        ...
                        <div class="container py-5">
                          <div class="row justify-content-center">
                            <div class="col-xl-6 col-lg-9 col-md-10 col-12 text-center">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="d-inline-block w-8 h-8 text-secondary mb-4" viewBox="0 0 975.036 975.036">
